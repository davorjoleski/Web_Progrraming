...
public class ItemsPage extends AbstractPage {
    ...
    public ItemsPage filter(String olderThanYears, String applicationType) {
        System.out.println(driver.getCurrentUrl());
        this.years.sendKeys(olderThanYears);
        Select select = new Select(this.applicationType);
        select.selectByValue(applicationType);
        this.filter.click();
        String url = "/?years=" + olderThanYears + "&applicationType=" + applicationType;
