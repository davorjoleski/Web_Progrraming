...
public class SeleniumScenarioTest {
    ...
    static {
        SubmissionHelper.exam = "kol2024-g2";
    ...
    public void test_list_15pt() {
        ...
        List<Application> items = this.applicationService.listAll();
    ...
    public void test_filter_5pt() {
        ...
        listPage.filter("", ApplicationType.TECHNOLOGY.name());
        listPage.assertItems(5);

        listPage.filter("30", ApplicationType.TECHNOLOGY.name());
    ...
    public void test_filter_service_5pt() {
        ...
        ExamAssert.assertEquals("without filter", 10, this.applicationService.filterApplications(null, null).size());
        ExamAssert.assertEquals("by years more than only", 5, this.applicationService.filterApplications(30, null).size());
        ExamAssert.assertEquals("by type only", 5, this.applicationService.filterApplications(null, ApplicationType.SOCIAL).size());
        ExamAssert.assertEquals("by years less than and type", 3, this.applicationService.filterApplications(30, ApplicationType.TECHNOLOGY).size());
    ...
    public void test_create_10pt() {
        ...
        List<Application> applications = this.applicationService.listAll();

        int itemNum = applications.size();
        ...
        listPage = AddOrEditApplication.add(this.driver, ADD_URL, "testName", "testOriginStory", date, ApplicationType.TECHNOLOGY.name(), scientists.get(0).getId().toString());
    ...
    public void test_create_mvc_10pt() throws Exception {
        ...
        MockHttpServletRequestBuilder addRequest = MockMvcRequestBuilders
                ...
                .param("applicationType", ApplicationType.TECHNOLOGY.name())
        ...
        ExamAssert.assertEquals("Number of items", itemNum + 1, applications.size());
    ...
    public void test_edit_10pt() {
        ...
        listPage = AddOrEditApplication.update(this.driver, listPage.getEditButtons().get(itemNum - 1), "testName", "testOriginStory", LocalDate.now().minusYears(30).toString(), ApplicationType.TECHNOLOGY.name(), scientists.get(0).getId().toString());
        listPage.assertNoError();

        AbstractPage.assertRelativeUrl(this.driver, LIST_URL);
        if (listPage.assertItems(itemNum)) {
            ExamAssert.assertEquals("The updated application name is not as expected.", "testName", listPage.getRows().get(itemNum - 1).findElements(By.tagName("td")).get(0).getText().trim());
        }
    ...
    public void test_edit_mvc_10pt() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .post("/applications/" + applications.get(itemNum - 1).getId())
                .param("name", "testName")
                .param("originStory", "testOriginStory")
                .param("dateCreated", LocalDate.now().minusYears(30).toString())
                .param("applicationType", ApplicationType.SOCIAL.name())
                .param("scientist", scientists.get(0).getId().toString());
        ...
        applications = this.applicationService.listAll();
        ExamAssert.assertEquals("Number of items", itemNum, applications.size());
        ExamAssert.assertEquals("The updated application name is not as expected.", "testName", applications.get(itemNum - 1).getName());

        request = MockMvcRequestBuilders
                .get("/applications/edit/" + applications.get(itemNum - 1).getId());
    ...
    public void test_delete_mvc_5pt() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .post("/applications/delete/" + items.get(itemNum - 1).getId());
        ...
        items = this.applicationService.listAll();
    ...
    public void test_security_urls_10pt() {
        ...
        List<Application> players = this.applicationService.listAll();
        String editUrl = "/applications/edit/" + players.get(0).getId();
    ...
    public void test_vote_3pt() throws Exception {
        ...
        AbstractPage.assertRelativeUrl(this.driver, LIST_URL);
        ExamAssert.assertEquals("The updated application votes number is not as expected.", "1", listPage.getRows().get(itemNum - 1).findElements(By.tagName("td")).get(5).getText().trim());
    ...
    public void test_vote_mvc_2pt() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .post("/applications/vote/" + applications.get(0).getId());
        ...
        applications = this.applicationService.listAll();
        ExamAssert.assertEquals("Number of votes", applications.get(0).getVotes(), 1);
    ...
    public static final String LIST_URL = "/applications";
    public static final String ADD_URL = "/applications/add";
