 ...
 * The 'Vote for Presentation' button should only be visible for a user with role of user.
 * <p>
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests( (requests) -> requests
                        .requestMatchers("/", "/presentations")

                        .permitAll()
                        .requestMatchers("/presentations/vote/{id}").hasRole("USER")
                        .anyRequest()
                        .hasRole("ADMIN")
