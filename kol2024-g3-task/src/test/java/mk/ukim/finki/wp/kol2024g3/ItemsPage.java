...
public class ItemsPage extends AbstractPage {
    ...
    public ItemsPage filter(String years, String presentationType) {
        System.out.println(driver.getCurrentUrl());
        this.years.sendKeys(years);
        Select select = new Select(this.presentationType);
        select.selectByValue(presentationType);
        this.filter.click();
        String url = "/?years=" + years + "&presentationType=" + presentationType;
    ...
    public WebElement getPresentationType() {
